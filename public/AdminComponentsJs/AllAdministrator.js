app.controller('AllAdministrator', function ($scope, $filter, $http) {
...
//////////////////////////////
  $scope.customerAssign = function(){
    ...
    var Success_Message = "Administrator Assigned to Customer Successfully.";
    var Fail_Message = "A problem was detected while assigning the Adminstrator.";
    var Pipeline_Data = {
