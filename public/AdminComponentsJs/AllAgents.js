app.controller('AllAgents', function ($scope, $filter, $http) {
...
/////////////////////// Table Functions /////////////////////////////////
  ...
  $scope.PassUpdate = function(){
    ...
    if($scope.newpass != ''){
      ...
      $scope.alertmessage = "Agent Failed! Password cannot be empty or less than 4 characters.";
      $scope.alertboxjs = {
        'display': "block",
        'background': "red",
        'color': "white"
  ...
  $scope.UserUpdate = function(){
    ...
    if($scope.editname != '' && $scope.editemail != '' && $scope.editphone != ''){
      ...
      $scope.alertmessage = "Agent Failed! Please fill all the fields.";
      $scope.alertboxjs = {
        'display': "block",
        'background': "red",
        'color': "white"
  ...
  $scope.customerAssign = function(){
    ...
    var Success_Message = "Agent Assigned to Customer Successfully.";
    var Fail_Message = "A problem was detected while assigning the Agent.";
    var Pipeline_Data = {
