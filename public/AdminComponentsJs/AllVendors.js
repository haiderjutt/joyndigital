app.controller('AllVendors', function ($scope, $filter, $http) {
...
/////////////////////// Table Functions /////////////////////////////////
  ...
  $scope.PassUpdate = function(){
    ...
    if($scope.newpass != ''){
      ...
      $scope.alertmessage = "Vendor Failed! Password cannot be empty or less than 4 characters.";
      $scope.alertboxjs = {
        'display': "block",
        'background': "red",
        'color': "white"
  ...
  $scope.UserUpdate = function(){
    ...
    if($scope.editname != '' && $scope.editemail != '' && $scope.editphone != ''){
      ...
      $scope.alertmessage = "Vendor Failed! Please fill all the fields.";
      $scope.alertboxjs = {
        'display': "block",
        'background': "red",
        'color': "white"
  ...
  $scope.customerAssign = function(){
    ...
    var Success_Message = "Vendor Assigned to Customer Successfully.";
    var Fail_Message = "A problem was detected while assigning the Vendor.";
    var Pipeline_Data = {
