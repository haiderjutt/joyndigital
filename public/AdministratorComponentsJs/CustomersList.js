app.controller('allCustomers', function($scope, $filter, $http, $interval) {
    ...
    var initload = function() {
        var PipelineData = {};
        $http.post('/Latitude/public/administrator/assigned/customers/all', JSON.stringify(PipelineData)).then(function(response) {
    ...
    $scope.ModalRequest = function() {
        ...
        var Req_Url = '/Latitude/public/administrator/assigned/user/crud';
