                ...
                <tbody style="font-size: 12px; background-color:#141414; hover:pointer;">
                    <tr ng-repeat="item in pagedItems[currentPage] | orderBy:sort.sortingOrder:sort.reverse | filter:test" class="tableentries">
                        ...
                        <td class="menu1">
                            ...
                            <button class="menu-item1 blue btn" ng-if="item.role != 'Customer' && item.role != 'Super Admin'	" title="View History" ng-click="FinalSequence(item,'sm','Delete')" data-toggle="modal" data-target="#FinalModal"><i class="fa fa-history"></i></button>
                            <button class="menu-item1 blue btn" title="View Sites" ng-if="item.role == 'Customer'" ng-click="FinalSequence(item,'sm','Delete')" data-toggle="modal" data-target="#FinalModal"><i class="fa fa-trash"></i></button>
