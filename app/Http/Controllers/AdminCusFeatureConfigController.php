...
class AdminCusFeatureConfigController extends Controller
{
    //
    ...
    public function featureconfiginit(Request $request){
    ...
    public function featureconfigCRUD(Request $request){
