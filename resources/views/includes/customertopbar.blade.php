...
<!-- <div class="col-md-5 topbarleftoptions" >
            <a  style="margin-right:5px;" ng-click="isShowHide(showcontrol)" class="bars">
                  <span class="icon1" ng-style="topbartopstyle"></span>
                  <span class="icon2" ng-style="topbarmiddlestyle"></span>
                  <span class="icon3" ng-style="topbarbottomstyle"></span>
...
<!-- <img src="images/logo.png" alt="LATITUDE" style=" height:30px; width:100px; z-index:1;">
       ...
       <div class="col-md-1" style="font-size:15px; color:white; margin-top:3px; test-align:right">
            <a title="Logout" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();" style="color:white; float:right;"><img src="./images/icons/Logouti.png" height="35" width="35"></a>
      </div>     
      <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
            @csrf
        </form> --> -->